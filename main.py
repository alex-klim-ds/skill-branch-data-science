...
def gradient_optimization_one_dim (func_1):
    xn = 10 # начальное значение
    for i in range (N):
        xn = xn - eps * derivation(xn)  # изменение аргумента на текущей итерации
    return round(xn, 2)
...
N = 50
eps = 0.001
def gradient_optimization_multi_dim(func_2):
    x1 = 4
    x2 = 10
    for i in range (N):
        x1 = x1 - eps * d_dx1 (x1, x2)
        x2 = x2 - eps * d_dx2 (x1, x2)
    return [round (x1, 2), round (x2, 2)]
print(gradient_optimization_multi_dim (func_2))